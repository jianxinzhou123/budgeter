...
export default function AddTransactionForm({ categories, onSuccess, onShowToast }: AddTransactionFormProps) {
  const [formData, setFormData] = useState({
    ...
    amount: "",
    description: "",
    date: "2025-01-01", // Static default value
  });
    ...
    try {
      ...
      if (response.ok) {
        setFormData({
          ...
          amount: "",
          description: "",
          date: new Date().toISOString().split("T")[0], // This is OK since it's after user interaction
        });
        onSuccess();
  ...
  return (
    <form
      ...
      className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700"
    >
